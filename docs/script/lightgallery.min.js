...
!(function (t, e) {
  ...
  var t = function () {
    return (t = Object.assign
      || function (t) {
        for (var e, i = 1, s = arguments.length; i < s; i++) for (const n in (e = arguments[i])) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
        return t;
  ...
  function n(t) {
    return t === 'href'
      ? 'src'
      : (t = (t = (t = t.replace('data-', '')).charAt(0).toLowerCase()
  ...
  const c = function (t, e, o, r) {
    ...
    const a = (function () {
      ...
      const s = Array(t);
      let n = 0;
      for (e = 0; e < i; e++) for (let o = arguments[e], r = 0, l = o.length; r < l; r++, n++) s[n] = o[r];
      return s;
    }(s, e));
    return (
      [].forEach.call(t, (t) => {
  ...
  const B = (function () {
    ...
    return (
      ...
      (s.prototype.buildStructure = function () {
        ...
        if (!(this.$container && this.$container.get())) {
          ...
          const r = this.settings.ariaDescribedby
            ...
            : '';
          const l = `lg-container ${
            this.settings.addClass
          } ${
            document.body !== this.settings.container ? 'lg-inline' : ''}`;
          const a = this.settings.closable && this.settings.showCloseIcon
      ...
      (s.prototype.getMediaContainerPosition = function () {
        ...
        const i = this.settings.defaultCaptionHeight || (e && e.clientHeight) || 0;
      ...
      (s.prototype.addHtml = function (t) {
        ...
        if (
          ...
          if (e) {
            ...
            (n !== '.' && n !== '#')
                || (e = this.settings.subHtmlSelectorRelative
                  && !this.settings.dynamic
                  ? i(this.items).eq(t).find(e).first()
                    .html()
                  : i(e).first().html());
          } else e = '';
        }
      ...
      (s.prototype.preload = function (t) {
        ...
        for (let i = 1; i <= this.settings.preload && !(t - i < 0); i++) this.loadContent(t - i, !1);
      }),
      ...
      (s.prototype.loadContent = function (t, e) {
        ...
        let P = 0;
        this.lGalleryOn
            || (P = this.zoomFromOrigin && this.currentImageSize
      ...
      (s.prototype.setDownloadValue = function (t) {
        if (this.settings.download) {
          ...
          if (!1 === e.downloadUrl || e.downloadUrl === 'false') this.outer.addClass('lg-hide-download');
          else {
